...
public class JobStatusBindery extends SeleniumWebDrivers{
...
//SEARCH PANEL
	...
	By clientddarrowsrc=By.xpath("//*[@id='dvMainContainer']/div[1]/div[1]/div[1]/div[1]/div[3]/span[1]/span[1]/span[2]/span[1]");
...
//STATIC EXCEL VARIABLES
	static String date,clientname,clientdepartment,serviceDepartment,service,jobID,jobname,specifications,quantity,unitprice,ordervalue,deliverby,delivertype,overexcel,value,newstatus;
...
//		GET NEW STATUS from JOB TESTDATA excel file
					 newstatus =xrj.getCellData("JobFilePath", "New Status", 2);
				}			
			}
		}
//***********GENERIC WAIT METHOD***********
...
//***********FIND REQUIRED DEPARTMENT***********
		public void departmenttab() throws InterruptedException
		{
			...
			for(WebElement dept:deptele)
			{
				...
				if((dept.getText()).equals(serviceDepartment))
				{
					dept.click();
					break;
				}
